...
const LogoAnimation = {
  hidden: {
    opacity: 0,
    pathLength: 0,
    fill: "rgba(var(--color-content), 0)"
  },
  visible: {
    opacity: 1,
    pathLength: 1,
    fill: "rgba(var(--color-content), 1)"
  }
};

export const AnimatedLogoSVG = ({ size = 30 }: LogoSVGProps) => {
  return (
    <motion.svg
      className={`fill-current stroke-current text-content `}
      width={size}
      height={size}
