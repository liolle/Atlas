        ...
        <BaseLayout>
            <section className="  flex h-full w-full gap-4   @container">
                <div className="flex h-full w-full overflow-y-auto ">
                    <div className="  flex h-full min-h-screen  flex-[3_1_0] flex-col   ">
                        <div className=" sticky left-0 top-0 z-10 flex w-[100%] flex-[0_0_70px]  items-center  justify-between  border-b-2 border-r-2 border-accent-2 px-4 backdrop-blur-sm ">
                            <PreviousPage>
                                <ArrowLeft />
                            </PreviousPage>
